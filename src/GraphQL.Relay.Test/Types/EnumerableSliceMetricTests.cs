...
{
    public class EnumerableSliceMetricTests : IClassFixture<EnumerableFixture>
    {
        private readonly EnumerableFixture fixture;

        public EnumerableSliceMetricTests(EnumerableFixture fixture)
        {
            this.fixture = fixture;
        }

        private IEnumerable<Blog> Blogs => fixture.Blogs;
